...
// routes.put('/militares/tempo_anterior/:id', MilitaresController.updateTempoAnterior);
// routes.delete('/militares/tempo_anterior/:id', MilitaresController.deleteTempoAnterior);
